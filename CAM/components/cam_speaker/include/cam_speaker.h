 ...
 *        구동 조사용으로 7가지 이벤트를 구분한다(2026-08-23 사용자 지시로 6->7 재설계 —
 *        "채널 스캔"과 "광고 전송"을 별개 소리로 분리). 각 이벤트는 cam_speaker_notify()로
 ...
 *        5 ADVERTISE_SENT   솔 0.1초   6 PING            시 0.1초
 *        7 PONG             도 0.1초
 */
typedef enum {
    ...
    SPK_EVT_PING,                 /* 6. 핑 — 시 0.1s */
    SPK_EVT_PONG,                 /* 7. 퐁(수신) — 도 0.1s */
    SPK_EVT_COUNT,
} cam_speaker_event_t;
