...
static const char *s_table[STR_COUNT][UI_LANG_COUNT] = {
    ...
    [STR_CFG_PENDING_SUFFIX]         = { " (적용 대기)",                " (pending)" },
    [STR_CFG_APPLIED_SUFFIX]         = { " (적용됨)",                   " (applied)" },
    [STR_CAPTURE_QUEUED_TOAST]       = { "캠 접속 대기 중 - 다음 접속 때 촬영합니다", "Waiting for CAM - it will shoot on next wake" },
    [STR_LABEL_PENDING_TINY]         = { "대기",                        "Pend" },
    ...
    [STR_LABEL_MIN_HOLD]       = { "최소 유지:", "Min hold:" },
    [STR_OPT_MIN_HOLD_LIST]    = { "30초\n1분\n3분\n5분", "30S\n1M\n3M\n5M" },
    [STR_OPT_TREND_SAMPLE_LIST] = { "3\n5\n10", "3\n5\n10" },
