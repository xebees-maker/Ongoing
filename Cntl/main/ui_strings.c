...
static const char *s_table[STR_COUNT][UI_LANG_COUNT] = {
    ...
    [STR_MSG_OVERRIDE_WARNING] = { "설정한 규칙대로 동작하지 않고, 직접 지정한 On/Off로 고정됩니다.",
                                    "The relay will stop following its configured rule and stay fixed at the On/Off you choose." },
